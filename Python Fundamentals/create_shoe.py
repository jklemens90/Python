...
def main():
    ...
    #create list of dictionaries. Iterate through list with for loop and issue warning if shoe type is unknown.
    ...
    #create_shoe function. Implemented by passing in our materials_list variable    
